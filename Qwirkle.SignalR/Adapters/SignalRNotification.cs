...
public class SignalRNotification : INotification
{
    ...
    public void SendInstantGameExpected(int playersNumberForStartGame, string userName) => _hubContextQwirkle.Clients.Group(HubQwirkle.InstantGameGroupName(playersNumberForStartGame)).SendAsync(INotification.ReceiveInstantGameJoined, userName);
}
...
public class PlayTilesShould
{
    ...
    private void AddTilesOnPlayers()
    {
        ...
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 2, PlayerId = Player9, TileId = 2 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 3, PlayerId = Player9, TileId = 3 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 4, PlayerId = Player9, TileId = 4 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 5, PlayerId = Player9, TileId = 5 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 6, PlayerId = Player9, TileId = 6 });

        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 11, PlayerId = Player3, TileId = 7 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 12, PlayerId = Player3, TileId = 8 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 13, PlayerId = Player3, TileId = 9 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 14, PlayerId = Player3, TileId = 10 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 15, PlayerId = Player3, TileId = 11 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 16, PlayerId = Player3, TileId = 12 });

        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 21, PlayerId = Player8, TileId = 13 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 22, PlayerId = Player8, TileId = 14 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 23, PlayerId = Player8, TileId = 15 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 24, PlayerId = Player8, TileId = 16 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 25, PlayerId = Player8, TileId = 17 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 26, PlayerId = Player8, TileId = 18 });

        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 31, PlayerId = Player14, TileId = 19 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 32, PlayerId = Player14, TileId = 20 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 33, PlayerId = Player14, TileId = 21 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 34, PlayerId = Player14, TileId = 22 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 35, PlayerId = Player14, TileId = 23 });
        _dbContext.TilesOnRack.Add(new TileOnRackDao { Id = 36, PlayerId = Player14, TileId = 24 });
    ...
    {
        InitTest();
        var tilesToPlay = new List<TileOnBoard> { new(TileColor.Blue, TileShape.Circle, Coordinate.From(-4, 4)), new(TileColor.Blue, TileShape.Clover, Coordinate.From(-4, 3)), new(TileColor.Blue, TileShape.Diamond, Coordinate.From(-4, 2)) };
    ...
    {
        InitTest();
        var tilesToPlay = new List<TileOnBoard> { new(TileColor.Blue, TileShape.Circle, Coordinate.From(-3, 4)) };
    ...
    public void ReturnOkAnd5PointsAfter2PlayersHavePlayed()
    {
        ...
        var tilesToPlay = new List<TileOnBoard> { new(TileColor.Green, TileShape.Circle, Coordinate.From(-3, 4)), new(TileColor.Green, TileShape.Square, Coordinate.From(-3, 5)), new(TileColor.Green, TileShape.Diamond, Coordinate.From(-3, 6)) };
    ...
    public void PersistGoodAfter2PlayersMoves()
    {
        ...
        {
            new(TileColor.Blue, TileShape.Circle, Coordinate.From(-5, 4)),
            new(TileColor.Blue, TileShape.Square, Coordinate.From(-5, 3)),
            new(TileColor.Blue, TileShape.Diamond, Coordinate.From(-5, 2))
        };
    ...
    {
        tilesOnBoard.Select(t => t.PositionX).ShouldBe(tilesPlayed.Select(t => t.Coordinate.X));
        tilesOnBoard.Select(t => t.PositionY).ShouldBe(tilesPlayed.Select(t => t.Coordinate.Y));

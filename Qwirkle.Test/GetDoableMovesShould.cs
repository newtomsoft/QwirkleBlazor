...
public class GetDoableMovesShould
{
    ...
    public GetDoableMovesShould()
    {
        ...
        var userService = new UserService(repository, new Mock<IAuthentication>().Object);
        ...
        var gameId = coreService.CreateGameWithUsersIds(usersIds.ToHashSet());
    ...
    private void ChangePlayerTilesBy(int playerId, IReadOnlyList<TileDao> newTiles)
    {
        ...
        for (var i = newTiles.Count; i < CoreService.TilesNumberPerPlayer; i++) _dbContext.TilesOnRack.Remove(tilesOnPlayer[i]);
    ...
    public void Return6NoComboTilesWhenBoardIsEmptyAndNoCombinationPossibleInRack()
    {
        ...
        noComboTile.SelectMany(t => t.Tiles).Select(t => t.Coordinate).ShouldAllBe(c => c == Coordinate.From(0, 0)); // all in coordinate (0,0)
    ...
    public void ReturnMaxItemsWhenBoardIsEmptyAndMaxCombinationInRackIsPossible()
    {
        ...
        //todo algo must return combos without coordinate changing :
    ...
    public void BoardNotEmptyScenario01()
    {
        ...
        {
            Coordinate.From(10, 51), Coordinate.From(11, 51), Coordinate.From(12, 51),
            Coordinate.From(9, 50), Coordinate.From(13, 50),
            Coordinate.From(10, 49), Coordinate.From(11, 49), Coordinate.From(12, 49),
        };
        ...
        noComboTile.SelectMany(t => t.Tiles).Select(t => t.Coordinate).ShouldBe(expectedCoordinates.OrderBy(c => c));
    ...
    public void BoardNotEmptyScenario03()
    {
        ...
        var expectedCoordinatesForNoComboTile = new List<Coordinate>
        {
            Coordinate.From(9, 50), Coordinate.From(10, 49), Coordinate.From(10, 52), Coordinate.From(12, 50),
        };
        ...
        noComboTile.SelectMany(t => t.Tiles).Select(t => t.Coordinate).ShouldBe(expectedCoordinatesForNoComboTile);
